...
def make_full_split(seed: int = 42) -> None:
    ...
    # Ensure has_image / has_spectrum columns exist (prepare.py writes them;
    # older labeled_index.csv files may lack them — fill from working_set.csv)
    if "has_image" not in labeled.columns:
