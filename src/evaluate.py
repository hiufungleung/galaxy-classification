...
MODEL_RESULTS = {
    "tabular":  CHECKPOINTS / "tabular/test_results_full.pkl",
    "image":    CHECKPOINTS / "image/test_results_configC.pkl",
    "spectral": CHECKPOINTS / "spectral/test_results_configA.pkl",
    "fusion":   CHECKPOINTS / "fusion/test_results_bestenc.pkl",
}
